  ...
  >
    ...
    I am a Software Developer &
      ...
      >
        ...
        >
          <li className="text-[#EA9999]">Freelancer</li>
          <li className="text-[#EA9999]">Blogger</li>
          <li className="text-[#EA9999]">Gamer</li>
          <li className="text-[#EA9999]">Creator</li>
          <li className="text-[#EA9999]">Student</li>
          <li className="text-[#EA9999]">Contributer</li>
        </ul>
      </span>
    </div>
  </div>
